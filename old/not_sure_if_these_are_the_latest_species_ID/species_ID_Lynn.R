...
nsv = 20 #... Number of seconds per videos
...
load(paste0(to.data.mono, merged.data.folder, "Master.RData")) #This loads the dataset "trajectory.data"
...
morph_mvt = summarize_trajectories(trajectory.data.filtered, write = T, to.data, calculate.median=F, merged.data.folder)
...
#--- Predict the species identity of individuals with svm1 model
...
#with identification_list = list of folders/files to analyze and script_ident= function that analyzes 1 folder or file
