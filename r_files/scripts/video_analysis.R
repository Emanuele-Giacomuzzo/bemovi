...
# Written orginally by Felix Moerman, adapted by Samuel Huerlemann & Emanuele Giacomuzzo
# Watch out: this script has been specifically written to be used on the Mendel computer
...
to.data.input <- "/media/mendel-himself/ID_061_Ema2/AHSize/13_threshold_analysis/t0/" #Important: keep the slash at th end
